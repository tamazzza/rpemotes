Config.Languages = {
    ['ka'] = { -- ქართული 🇬🇪
        ['emotes'] = 'ემოციები 🎬',
        ['danceemotes'] = "🕺 საცეკვაო ემოციები",
        ['animalemotes'] = "🐩 ცხოველების ემოციები",
        ['propemotes'] = "📦 ნივთების ემოციები",
        ['favoriteemotes'] = "🌟 ფავორიტები",
        ['favoriteinfo'] = "აირჩიეთ ემოცია, რათა დააყენოთ ფავორიტად",
        ['rfavorite'] = "ფავორიტების განულება",
        ['prop2info'] = "❓ ნივთების ემოციები შეიძლება იყოს ბოლოში",
        ['set'] = "დააყენეთ (",
        ['setboundemote'] = ") -ემოცია სწრაფ სლოტზე",
        ['newsetemote'] = "~w~ -ემოცია განთავსდა სწრაფ სლოტზე, გამოიყენეთ ~g~CapsLock~w~ მის გასააქტიურებლად.",
        ['cancelemote'] = "ემოციის გამორთვა 🚷",
        ['cancelemoteinfo'] = "~r~X~w~ აუქმებს მიმდინარე ემოციას",
        ['walkingstyles'] = "სვლის სტილი 🚶🏻‍♂️",
        ['resetdef'] = "ქარხნულ პარამეტრებზე დაბრუნება",
        ['normalreset'] = "ნორმალური (გადატვირთვა)",
        ['moods'] = "განწყობები 😒",
        ['infoupdate'] = "კრედიტები და შემოთავაზებები 🙏🏻",
        ['infoupdateav'] = "ინფორმაცია (განახლება ხელმისაწვდომია)",
        ['infoupdateavtext'] = "ხელმისაწვდომია განახლება, ჩამოტვირთეთ უახლესი ვერსია ~y~https://github.com/tamazzza~w~",
        ['suggestions'] = "შემოთავაზებები?",
        ['suggestionsinfo'] = "~r~taz.o~s~ FiveM ფორუმზე ნებისმიერი ფუნქციის/ემოციას შემოთავაზებისთვის! ✉️",
        ['notvaliddance'] = "არასწორი საცეკვაო ემოციაა.",
        ['notvalidemote'] = "არასწორი ემოციაა.",
        ['nocancel'] = "გასაუქმებელი ემოცია არ არის.",
        ['maleonly'] = "ეს ემოცია მხოლოდ მამაკაცებისთვისაა!",
        ['emotemenucmd'] = "გამოიყენეთ /emotemenu ანიმაციების მენიუს გასახსნელად.",
        ['shareemotes'] = "👫 საზიარო ემოციები",
        ['shareemotesinfo'] = "მოიწვიეთ ახლოს მყოფი მოთამაშე ემოციისთვის",
        ['sharedanceemotes'] = "🕺 საზიარო ცეკვები",
        ['notvalidsharedemote'] = "არასწორი საზიარო ემოციაა.",
        ['sentrequestto'] = "მოთხოვნა გაგზავნილია ~y~",
        ['nobodyclose'] = "არავინ არის ~r~მიმდებარედ~w~.",
        ['doyouwanna'] = "~y~Y~w~ დათანხმება, ~r~L~w~ უარყოფა (~g~",
        ['refuseemote'] = "ემოცია უარყოფილია.",
        ['makenearby'] = "აიძულებს ახლოს მყოფ მოთამაშეს ემოცია შეასრულოს",
        ['useleafblower'] = "დააჭირეთ ~y~G~w~ ფოთლის ეფექტისთვის.",
        ['camera'] = "დააჭირეთ ~y~G~w~ კამერის გასანათებლად.",
        ['makeitrain'] = "დააჭირეთ ~y~G~w~ წვიმის შესაქმნელად.",
        ['pee'] = "დააჭირეთ და გეჭიროთ ~y~G~w~ მოსაშარდათ.",
        ['spraychamp'] = "დააჭირეთ და გეჭიროთ ~y~G~w~ შამპანურის შესასხურებლად.",
        ['stun'] = "დააჭირეთ ~y~G~w~ ელექტროშოკერის გამოსაყენებლად.",
        ['vape'] = "დააჭირეთ ~y~G~w~ მოსაწევად.",
        ['bound'] = "დაკავშირებული ",
        ['to'] = "კენ",
        ['currentlyboundemotes'] = " სწრაფ სლოტზე მქონე ემოციები:",
        ['notvalidkey'] = "არასწორი კლავიშია.",
        ['keybinds'] = "🔢 კლავიშთა კომბინაციები",
        ['keybindsinfo'] = "გამოიყენეთ",
        ['searchemotes'] = "🔍 ემოციების ძებნა",
        ['searchinputtitle'] = "ძებნა:",
        ['searchmenudesc'] = "%s შედეგი '~r~%s~w~' -ისთვის:",
        ['searchnoresult'] = "შედეგი არ მოიძებნა '~r~%s~w~'.",
        ['searchshifttofav'] = "დააჭირეთ L-Shift-ს და Enter-ს ფავორიტად დასაყენებლად.",
        ['searchcantsetfav'] = "საერთო ემოციები ვერ დაყენდება ფავორიტად.",
        ['invalidvariation'] = "არასწორი ტექსტურის ვარიანტია. დასაშვები ვარიანტებია: %s",
        ['firework'] = "დააჭირეთ ~y~G~w~ ფეიერვერკის გამოსაყენებლად",
        ['poop'] = "დააჭირეთ ~y~G~w~ მოსასაქმებლად",
        ['puke'] = "დააჭირეთ ~y~G~w~ გულისრევისთვს",
        ['btn_select'] = "არჩევა",
        ['btn_back'] = "უკან",
        ['btn_switch'] = "შეცვლა",
        ['btn_increment'] = "გაზრდა"
    },
